...
//                     this.currentElem = $(currentElem).children().children('.line')[0];
//
//                 } else {
...
//                     this.currentElem = $(currentElem).children('.line')[0];
//
//                 }
//                 break;
//
...
//                     // Создаем элементы
//                     this.render();
//                     this.currentElem = $(this.container).children().children().children('.line')[0];
//
//                 } else {
//
...
// Версия перед преобразованием блока изменений в массив
...
//
//             let blockChanges = this;
//             let index = (renderTrees.id) ? renderTrees.id + 1 : renderTrees.number;
//
//             this.elem = $(`#change_${index}`);
//             this.input = $(`#change__field_${index}`);
//             this.saveButton = $(`#change__save_${index}`);
//             this.addButton = $(`#change__add_${index}`);
//             this.delButton = $(`#change__del_${index}`);
//
//             // Функции нажатия на кнопки
//             this.saveButton.click(function () {
//                 blockChanges.save();
...
//     getNames: function () {
//         return {
//             parent: this.currentElem.parentNode.parentNode.parentNode.childNodes[0].innerText.match(/\w+/)[0],
